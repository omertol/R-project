...
A 'group' ( called synapse) is formed when two neurons create a connection by transferring electric signals between one another.
...
The electrodes, on which the neurons are bred, monitor and document every connection made in each of the petri dishes.
