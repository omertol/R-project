...
```{r}
#Load data
list_df <- list.files("C:\\Users\\stavf\\Downloads\\my data files", pattern="*.csv", full.names=TRUE)
df<-read.csv(file = "C:\\Users\\stavf\\Downloads\\Petri&Treatment.csv")[1:2]
...
pairwise_knn <- function(join_df){
  ...
  knn_model <- knn(train=train,test=test,cl=target, k=11)
